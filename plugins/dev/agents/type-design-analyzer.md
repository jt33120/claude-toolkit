...
A type with strong invariants doesn't replace testing it — pair this agent's review with `tdd`
so the invariants you recommend actually have a failing test proving they're enforced, not just
a code review comment saying they should be.
